...
warning('ita_vbap_pan: Deprecation warning. Function will be replaced by ita_pan_vbap in the future. Consider using ita_pan_vbap instead.');

%% Preliminary tests
opts.distanceloss = false;
