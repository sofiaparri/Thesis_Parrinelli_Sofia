classdef itaOrientation
    ...
    methods
        ...
        function this = set.roll_deg(this,value)
            ...
            this.mOrient = ita_rpy2quat(deg2rad(value), this.pitch, this.yaw);
        end
        ...
        function this = set.pitch_deg(this,value)
            ...
            this.mOrient = ita_rpy2quat(this.roll, deg2rad(value), this.yaw);
        end
        ...
        function this = set.yaw_deg(this,value)
            ...
            this.mOrient = ita_rpy2quat(this.roll, this.pitch, deg2rad(value));
        end
