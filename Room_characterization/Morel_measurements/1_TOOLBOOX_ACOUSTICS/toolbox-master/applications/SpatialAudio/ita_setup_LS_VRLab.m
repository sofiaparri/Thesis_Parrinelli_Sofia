...
opts.coordSystem        = 'itaCoordinates'; % 'openGL'  || indicates in which coordinate system the output is, do not mix opengl with itaCoordinates system!
...
if opts.isItaCoordinates && strcmpi(opts.coordSystem,'opengl')
    error('You are using openGL coordinates in an itaCoordinates. Convert before and after this function using ita_openGL2Matlab and ita_matlab2openGL')
end
