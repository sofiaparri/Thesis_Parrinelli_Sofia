...
clear tmp;% create a multi instance again
...
function triggerTimeOut = triggerTime(dataMotor)
    ...
    [~,triggerTimeOut] = findpeaks(dataMotor.timeData,dataMotor.samplingRate,'MinPeakDistance',1,'MinPeakHeight',0.75*max(abs(dataMotor.timeData)));
