...
%
% This tutorial is about creating an image sources model. TO BE CONTINUED 
% 
% 
%
%
...
%% Init
file        = fullfile(ita_toolbox_path, 'applications', 'SoundFieldSimulation', 'ImageSources', 'box.dae');
receiverPos = [1 1 1.5]; %green
sourcePos   = [2 2 2]; %red 
order       = 2;
%% load data
